...
export const useMusicPlayer = () => {
  ...
  // Inicializa o elemento de áudio e listeners
  useEffect(() => {
  ...
  }, [playerState.currentSong, playerState.isPlaying, playerState.isLoading, playerState.error, playSong, playerState.currentPlaylist]);
